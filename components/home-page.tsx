  ...
  return <main>
    ...
    <section className="celebrations-home">
      ...
      <div className="venue-home-grid">
        <Link href="/wedding-hall"><img src="/images/grand-hall-gallery/nakshatra69.jpeg" alt="The Nakshatra Grand Hall prepared for a wedding" loading="lazy"/><div><span><Building2/>01</span><h3>The Grand Hall</h3><p>Approximately 5,500 sq ft for luminous indoor celebrations.</p><b>Explore the hall <ArrowRight/></b></div></Link>
