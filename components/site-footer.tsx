  ...
  return <footer className="footer">
    ...
    <div className="footer-main">
      <div className="footer-brand">
        <span className="brand-orbit large" aria-hidden="true"><span>N</span></span>
        <p className="kicker">NAKSHATRA HOTEL &amp; RESORT</p>
        <h2>Come away<br/><em>restored.</em></h2>
      </div>
      <div className="footer-links">
        <div><p className="footer-title">Explore</p><Link href="/rooms">Rooms & suites</Link><Link href="/amenities">Amenities</Link><Link href="/restaurant">Restaurant</Link><Link href="/gallery">Gallery</Link></div>
        <div><p className="footer-title">Celebrate</p><Link href="/wedding">Weddings</Link><Link href="/conference-and-meetings">Meetings</Link><Link href="/birthday-party">Birthdays</Link><Link href="/pool-party">Pool parties</Link></div>
