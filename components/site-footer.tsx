  ...
  return <footer className="footer">
    ...
    <div className="footer-main">
      ...
      <div className="footer-links">
        <div><p className="footer-title">Explore</p><Link href="/our-story">Our story</Link><Link href="/rooms">Rooms & suites</Link><Link href="/amenities">Amenities</Link><Link href="/restaurant">Restaurant</Link><Link href="/gallery">Gallery</Link><Link href="/parking">Parking & arrival</Link></div>
